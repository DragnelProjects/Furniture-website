...
function ContactIntro() {
  ...
  useGSAP(() => {
    document.fonts.ready.then(() => {
      const introSplit = new SplitText('#subtext', {type: 'lines'});
  ...
  return (
    <div className='h-[40vw] w-full relative just_col z-10 '>
        ...
        <img src={Leaf} id='sideLeaf' className='h-[46vw] absolute rotate-85 -top-4 -left-1 -z-2 ' />
        <h2 id='subtext' className='text-6xl text-center tracking-wide w-130  '>Our do<span className='text-[#f8f8f8] '>ors</span> <span className='text-[#f8f8f8] '>are</span> always <span className='text-[#f8f8f8] '>open!</span></h2>
        <div className='h-[24vw] w-[42vw] absolute top-[28%] left-[44%] bg-[white] -z-5 '>
            ...
            <img id='yellow' src={YellowChair} className='h-[22vw] absolute left-55 -bottom-18 z-15 ' />
        </div>
    </div>
  )
}
